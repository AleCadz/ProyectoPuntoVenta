...
class SignupWindow(BoxLayout):
	...
	def verificar_usuario(self, username, password):
		...
		if users:
			if username=='' or password=='':
				...
				if usuario:
					if usuario['password']==password:
						...
						self.ids.signup_notificacion.text=''
						...
						self.ids.signup_notificacion.text='Usuario o contraseña incorrecta'
				else:
					self.ids.signup_notificacion.text='Usuario inexistente'
		else:
			...
			self.ids.signup_notificacion.text='Se creo primer usuario. usuario 123'
